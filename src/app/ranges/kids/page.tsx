...
const KidsRangesPage: React.FC = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [sortOption, setSortOption] = useState('');
  const [filterCategory, setFilterCategory] = useState('');

  // Product list with categories
  const products = getProductsByRange('kids');
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="relative w-full max-w-lg p-5">
              ...
              <div className="relative w-full aspect-[3/4] mt-2 overflow-hidden bg-transparent" 
                ...
                <Image
                  src="/kids/ivory-pearl-tulle-dress.png"
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-base leading-relaxed text-gray-300 max-w-xl">
              ...
              Luxury begins early — let them shine with Zayora. Every piece is crafted with care for the young ones who deserve the best.
            </p>
      ...
      {/* Decorative Star */}
      <div className="absolute -bottom-8 -right-10 opacity-60 -rotate-90">
        <Image
          src="/star3.svg"
          alt="Star decoration"
          width={150}
